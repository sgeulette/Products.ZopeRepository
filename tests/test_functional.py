...
from Products.ZopeRepository.tests.ZopeRepositoryTestCase import ZopeRepositoryTestCase

PACKAGE = 'Products.ZopeRepository.tests'

REQUIRE_TESTBROWSER = ['tst_zoperepository.txt']
