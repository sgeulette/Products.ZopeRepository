# -*- coding: utf-8 -*-
#
# File: ZopeRepositoryTestCase.py
#
...
class ZopeRepositoryTestCase(testcase):
    """Base TestCase for contacts."""

    ##code-section class-header_ZopeRepositoryTestCase #fill in your manual code here
    def afterSetup(self):
        """
...
#        self.portal.portal_setup.runImportStep(step_id="fillinleftslots-cpskin2")
    ...
    ##/code-section class-header_ZopeRepositoryTestCase
...
def test_suite():
    ...
    suite = TestSuite()
    suite.addTest(makeSuite(ZopeRepositoryTestCase))
    return suite
